  ...
  "news": [
    {
      ...
      "date": "2026-09-10",
      "title": { "fr": "…", "en": "…" },
      "number": "12,9 Md$", "number_en": "$12.9B",
      "number_label": { "fr": "…", "en": "…" },
      "body": { "fr": "2 à 4 phrases", "en": "…" },
...
- Texte très bref, lisible en quelques secondes. Un chiffre marquant et vérifiable par news.
...
Desktop uniquement (souris). Les monstres sortent de derrière le logo et avancent. Clic pour tirer, 6 cartouches, rechargement automatique (ou touche R), 5 vies. Le jeu se met en pause quand la souris quitte le header ou que le header sort de l'écran. Sprites en bitmaps dans `assets/game.js`.
